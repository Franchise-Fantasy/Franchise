  ...
  const { data: draft } = useQuery({
    ...
    queryFn: async () => {
      const { data, error } = await supabase
        .from('drafts')
        .select('id, draft_type, time_limit, accelerate_after_round, accelerated_time_limit, status, season, type, quiet_hours_enabled, quiet_hours_start_min, quiet_hours_end_min')
