...
- [ ] Prospect Scouting Section (Contentful CMS + 3 screens) — see prospect plan. Phase 1: DB + webhook + Hub. Phase 2: Profile + news. Phase 3: My Board + draft integration.
  - [ ] Board consensus rankings — anonymous aggregate of all users' boards, show community vs personal rank
  - [ ] Dynasty context overlay — "this prospect would be your #3 PG"
  - [ ] Draft pick value mapping — highlight prospects in range of your actual picks
  - [ ] League-aware position scarcity — "only 2 centers in this class"
  - [ ] Prospect-to-active-player comparison — comparable player trajectories via aging curves
- [ ] AI-generated yearly redrafts with overpick/underpick analysis

## Tier 4 — Future

- [ ] Similarity-based player curves.
