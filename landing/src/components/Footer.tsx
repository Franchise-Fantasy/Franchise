...
import { SOCIALS as SOCIAL_URLS } from "@/config/site";
import { useTheme } from "./ThemeProvider";

// Brand glyph paths from simple-icons (24×24 viewBox). Inline-SVG keeps the
// landing dependency-free — no icon library is installed. URLs come from the
// shared site config so they stay in sync with the JSON-LD `sameAs` entries.
const SOCIALS = [
  {
