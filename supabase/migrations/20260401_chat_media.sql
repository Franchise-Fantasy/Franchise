-- Chat media support: photos (Supabase Storage) and GIFs (Tenor URLs)
-- New message types: 'image' and 'gif'

-- 1. Create chat-media storage bucket (public read, service-role write)
...
-- 2. Update get_conversations to preview image/gif messages
